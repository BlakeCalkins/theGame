...
def archetype_averages():
    ...
    print("gambler_dmg_given: ", test_one_hundred_thousand_times(gmb))
    ...
    print("broker turns: ", test_one_hundred_thousand_times_turns(bro))
